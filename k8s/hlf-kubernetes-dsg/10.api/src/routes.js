...
router.post('/registerUser',main.registerUser)
router.get('/getBarDetailsByToken',main.getListData)
router.get('/getBar',main.getBar)
router.get('/queryBar',main.queryBar)
router.post('/createBar', main.createBar);
router.post('/createBarWithToken', main.createBarWithToken);
router.post('/createBuyWithToken', main.createBuyWithToken);
router.post('/createSellWithToken', main.createSellWithToken);
router.post('/createSendWithToken', main.createSendWithToken);
